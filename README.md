# Olá! Eu sou Jefferson Santos (javsgithub) 👋 

Profissional em plena transição de carreira, lincenciado em Letras Português e Inglês e com mais de 10 anos de experiência em atendimento e suporte administrativo no setor público.
Hoje, direciono minha disciplina e foco para o desenvolvimento front-end e para a construção de soluções inteligentes em tecnologia.
...
- **Front-end:** HTML, CSS, JavaScript, TypeScript, React.js, Sass, Less  
- **Ferramentas:** Git, GitHub, Gulp, Grunt  
- **Outros:** Noções de Vue.js, estudos em Node.js e React Native
...
![falvojr's GitHub stats](https://github-readme-stats.vercel.app/api?username=javsgithub&show_icons=true&theme=dark) 

## 🧠 Linguagens Mais Usadas 

![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=javsgithub&layout=compact&theme=dark)
